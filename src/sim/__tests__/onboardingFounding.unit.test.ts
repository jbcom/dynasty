...
// NA-11: the "authored-Epoch-0 self-exclusion" suite is removed — the Epoch-0 narrative surface it
// pinned is retired (the saga acts are the played story now; coverage is verified by the saga-act
// acceptance test in ob6-all-origins.unit.test.ts).
