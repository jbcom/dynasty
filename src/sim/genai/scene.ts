...
import spineScenePlansData from "../../data/saga/spine-scene-plans.json" with { type: "json" };
...
const SPINE_SCENE_PLANS = spineScenePlansData as Record<string, SpineScenePlan[]>;
