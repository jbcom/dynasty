...
const ledger: LedgerEntry[] = [
  { seq: 0, sourceChoice: "excel", sourceEvent: "ev_military_school", year: 1959, ruleId: "discipline", text: "x" },
  { seq: 1, sourceChoice: "go_big", sourceEvent: "ev_first_deal", year: 1976, ruleId: "media", text: "y" },
  { seq: 2, sourceChoice: "go_big", sourceEvent: "ev_casino", year: 1990, ruleId: "debt", text: "z" },
];
