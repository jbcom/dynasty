...
- [ ] [WAIT] PR #33 (EX-1/2/3 breadth: place arcs + athletic depth + place-gate infra) CI green → address threads → squash-merge → sync main. EX-4+ opens on a fresh branch off merged main.
