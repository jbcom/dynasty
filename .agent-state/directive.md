...
- [ ] nb-006 wire market holdings to choices (markets currently inert); add heat passive decay; cap/rebalance the power=30 outlier + cut the ~24% no-downside choices; throttle the 1-click walked_away early-out; fix historical date nits (John G. Trump MIT 1936/EE; JPK Harvard 1912 / Columbia Trust 1913); populate ending body/branch-conditional text; add gap events (Epstein, Trump children/heirs, 2000 Reform run). Agent-parallelizable.
