...
const INTERSTITIALS = [
  ...
  inter(
    ...
    "sound",
    [
      "Once the platform was set, the response came back as a roar {given_name} {surname} could read like a meter — the switchboard's overload, the affiliates' calls, the low hum of a country reacting to having been told what it was. To shape the national story is to be answerable to everyone who heard it, all at once.",
  ...
  inter(
    ...
    "sight",
    [
      "With the digital doctrine committed, {given_name} {surname} watched its first effects scroll past on a wall of dashboards — adoption curves, sentiment graphs, the slow visible bending of behavior toward what the family's systems rewarded. A doctrine written into code does not argue; it simply becomes the world its users live in.",
  ...
  inter(
    ...
    "touch",
    [
      "The turn taken, {given_name} {surname} felt its consequence in the faint, constant thrum of the shipyards retooling — the whole vast apparatus of the house reorienting around a single decision, mass and money and ten thousand careers swinging onto a new heading like a station coming about.",
  ...
  inter(
    ...
    "sight",
    [
      "The terminal expansion set in motion, {given_name} {surname} watched the tactical display bloom with the slow lights of seeded worlds and outbound ships, the {family_name} name spreading across a volume of space too large for any mind to hold at once. To act on this scale is to launch consequences that will outlive not just the actor but the civilization that produced them.",
